...
jar cvf ../Treg_2D.jar *	# create a jar containing everything in this temporary direcetory, and place the jar one level up. 
cd ..				# cd back out of the temporary dir. 

echo "ARTIMMUS jar compilation complete." 
