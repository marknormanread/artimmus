...
See the 'README.pdf' document for detailed installation and execution instructions. 
...
For purely historic reasons of how the project developed, many of the analysis scripts shipped herein require that all the code hosted here be held within a directory named "Treg_2D". 
